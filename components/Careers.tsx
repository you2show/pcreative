    ...
    <PageOverlay title={t("Careers", "ឱកាសការងារ")} bgText="JOIN US" onClose={onClose}>
         <div className="max-w-4xl mx-auto">
             <div className="text-center mb-16">
                 ...
                 <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6 font-khmer">
                    {t("Join the Revolution", "ចូលរួមជាមួយបដិវត្តន៍")}
                 </h1>
                 <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed font-khmer">
                    {t(
             ...
             <div className="grid gap-6">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4 font-khmer border-b border-gray-200 dark:border-white/10 pb-4">
                    {t("Open Positions", "តួនាទីដែលកំពុងជ្រើសរើស")}
                </h2>
                
                {jobs.map((job) => (
                    <div key={job.id} className="group bg-gray-100 dark:bg-white/5 border border-gray-100 dark:border-white/5 hover:border-indigo-500/50 hover:bg-gray-200 dark:hover:bg-white/10 p-6 rounded-2xl transition-all duration-300 flex flex-col md:flex-row items-center justify-between gap-6">
                        <div className="flex items-center gap-6 w-full md:w-auto">
                            <div className="w-16 h-16 rounded-2xl bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-white/10 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform text-indigo-400">
                                {job.icon}
                            </div>
                            <div>
             ...
             <div className="mt-20 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-white/10 rounded-3xl p-8 md:p-12 text-center">
                 <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4 font-khmer">{t("Don't see your role?", "មិនឃើញតួនាទីរបស់អ្នក?")}</h2>
                 ...
                 <a 
                    ...
                    className="inline-flex items-center gap-2 px-8 py-3 rounded-full border border-gray-300 dark:border-white/20 text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-white hover:text-gray-900 transition-all font-bold"
                 >
                    Contact Us Anyway
                 </a>
             </div>
