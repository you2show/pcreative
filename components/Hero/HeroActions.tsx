  ...
  return (
    <div className="space-y-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
            <MagneticButton 
            href="/contact"
            className="group px-8 py-4 rounded-full bg-gray-900 text-white dark:bg-white dark:text-gray-950 font-bold text-lg shadow-xl shadow-black/25 dark:shadow-white/15 hover:shadow-2xl hover:shadow-indigo-500/30 dark:hover:shadow-indigo-300/20 flex items-center justify-center gap-2 font-khmer w-full sm:w-auto transition-shadow"
            >
