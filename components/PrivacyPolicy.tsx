    ...
    <PageOverlay title={t("Privacy Policy", "គោលការណ៍​ភាព​ឯកជន")} bgText="PRIVACY" onClose={onClose}>
        <div className="max-w-3xl mx-auto">
             <div className="flex items-center gap-4 mb-8 pb-8 border-b border-gray-200 dark:border-white/10">
                 ...
                 <div>
                     <h1 className="text-3xl font-bold text-gray-900 dark:text-white font-khmer">{t("Privacy Policy", "គោលការណ៍​ភាព​ឯកជន")}</h1>
                     <p className="text-gray-600 dark:text-gray-400 text-sm mt-1">Last Updated: March 2025</p>
                 </div>
             </div>

             <div className="space-y-10 text-gray-700 dark:text-gray-300 leading-relaxed font-khmer">
                 <section>
                 ...
                 <section>
                     ...
                     <p className="mt-4 font-bold text-gray-900 dark:text-white">creative.ponloe.org@gmail.com</p>
                 </section>
             </div>
        </div>
    </PageOverlay>
